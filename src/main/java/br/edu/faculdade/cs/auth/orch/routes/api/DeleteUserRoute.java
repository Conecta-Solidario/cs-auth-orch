...
@Component
public class DeleteUserRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        from("direct:deleteUser")
            .routeId("apiDeleteUserRoute")
            .log("API: DELETE USER (protegido) por ${header.userEmail}")
            .process(jwtValidationProcessor)
            .to("direct:call-cs-auth-delete-user");
    }
}
